 ...
 *
 */
void esp_mbedtls_ssl_tls13_conf_early_data(mbedtls_ssl_config *conf,
 ...
 *
 */
void esp_mbedtls_ssl_tls13_conf_max_early_data_size(
 ...
 *
 * \note           This function behaves mainly as esp_mbedtls_ssl_read(). The
 *                 specification of esp_mbedtls_ssl_read() relevant to TLS 1.3
 *                 (thus not the parts specific to (D)TLS 1.2) applies to this
 *                 function and the present documentation is restricted to the
 *                 differences with esp_mbedtls_ssl_read().
 *
 * \param ssl      SSL context
 * \param buf      buffer that will hold the data
 * \param len      maximum number of bytes to read
 ...
 *                 function and the present documentation is restricted to the
 *                 differences with esp_mbedtls_ssl_write().
 *
 * \param ssl      SSL context
 * \param buf      buffer holding the data
 * \param len      how many bytes must be written
