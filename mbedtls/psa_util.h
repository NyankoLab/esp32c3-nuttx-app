 ...
 * esp_mbedtls_hash_info_psa_from_md() from the internal hash_info.h instead.
...
static mbedtls_f_rng_t *const esp_mbedtls_psa_get_random = esp_mbedtls_ctr_drbg_random;
#elif defined(MBEDTLS_HMAC_DRBG_C)
#include "mbedtls/hmac_drbg.h"
typedef mbedtls_hmac_drbg_context mbedtls_psa_drbg_context_t;
static mbedtls_f_rng_t *const esp_mbedtls_psa_get_random = esp_mbedtls_hmac_drbg_random;
#endif
extern mbedtls_psa_drbg_context_t *const esp_mbedtls_psa_random_state;

#define MBEDTLS_PSA_RANDOM_STATE esp_mbedtls_psa_random_state
